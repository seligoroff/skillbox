      ...
      <form class="cart__form form" action="#" method="POST">
        ...
        <div class="cart__block">
          ...
          <div class="cart__total">
            ...
            <p>Итого: <b>3</b> товара на сумму <b>{{ $store.state.orderInfo.totalPrice |  numberFormat}} ₽</b></p>
          </div>
        </div>
      </form>
    </section>
...
export default {
    ...
    created() {
        if (this.$store.state.orderInfo && this.$store.state.orderInfo.id == this.$route.params.orderId) {
            return; 
        }
